# 🚀 Script de Configuración Automática para Smart Chatbot
# Este script configura Git y GitHub automáticamente
...
if (Test-Path ".git") {
    Write-Host "🗑️  Eliminando Git anterior..." -ForegroundColor Yellow
...
Write-Host "📍 Tu código está en: $repoUrl" -ForegroundColor Cyan
Write-Host "🔐 Tu archivo .env está protegido y NO se subió a GitHub" -ForegroundColor Green
